...
export default function Contact() {
  ...
  return (
    <section className="container">
      <div className="w-full flex justify-between items-center bg-accent  lg:pl-[100px]">
        <div className=" rounded-[45px] w-full lg:w-[50%]   py-[40px] md:py-[60px] p-10 lg:px-0 flex flex-col lg:flex-row items-center ">
        ...
        <div className="hidden lg:flex justify-end ">
          <Image
            ...
            width={690}
            height={600}
            className="w-full h-[600px] object-contain max-w-[670px]"
          />
        </div>
      </div>
    </section>
