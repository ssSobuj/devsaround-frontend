...
export default function Footer() {
  return (
    <footer className=" container mt-10 lg:mt-[100px] px-0 lg:px-[16px] xl:px-[100px]">
      <div className="flex flex-col bg-foreground text-background rounded-none lg:rounded-t-[45px] px-4 py-8 md:px-[60px] md:pt-[55px] md:pb-[50px]">
        <div className="flex flex-col gap-10 md:gap-[66px]">
          ...
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-12 lg:gap-x-4 mt-8 md:mt-0">
            <div className="col-span-12 lg:col-span-5 flex flex-col gap-[27px] text-center lg:text-left">
              <h4 className="text-foreground bg-primary w-fit font-medium rounded-[7px] px-[7px] leading-[100%] tracking-[0] mx-auto lg:mx-0">
                Contact us:
              </h4>
            ...
            <div className="col-span-12 lg:col-span-7 flex flex-col md:flex-row justify-center items-center gap-5 bg-[#292A32] py-[40px] px-[20px] md:py-[58px] md:px-[40px] rounded-[14px] text-center">
              <Button
                variant="outline"
                className="border-background text-background hover:bg-transparent h-fit w-full md:w-auto "
              >
                Email
              </Button>
        ...
        <div className="flex flex-col md:flex-row items-center  gap-3 md:gap-6 lg:gap-10 pt-[50px] text-center">
